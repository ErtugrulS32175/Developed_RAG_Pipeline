"""Vendored pure post-processing functions from microsoft/table-transformer
(MIT License), src/inference.py lines ~123-511 -- the DETR-output -> table
structure -> cells chain. Model building / matplotlib / pandas / argparse parts
are omitted; we load models via HF transformers and write our own cell adapter."""
...
from pipeline import _tatr_postprocess as postprocess
