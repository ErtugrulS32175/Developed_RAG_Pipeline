"""Vendored from microsoft/table-transformer (MIT License), src/postprocess.py.
Pure table-structure post-processing. Model building is intentionally NOT
vendored -- we load the DETR models via HF transformers. Requires PyMuPDF (fitz)
for its Rect geometry. See the table-module-status memory."""
"""
